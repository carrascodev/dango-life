...
LIBBUTANO   :=  ../../butano
PYTHON      :=  python3
SOURCES     :=  src ../../common/src src/generated src/pathfinding src/production src/actor
INCLUDES    :=  include include/generated include/pathfinding include/production include/actor ../../common/include
DATA        :=
